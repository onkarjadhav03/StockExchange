...
//function to  sorted by pricing
function sortedByPricing() {
  return;
}

//function to  sorted by pricing'
function Pricing(stock1, stock2) {
  return stock2.price - stock1.price;
}
//Endpoint 1: Get the stocks sorted by pricing'
app.get('/stocks/sort/pricing', (req, res) => {
  let copyStocks = stocks.slice();
  copyStocks.sort(Pricing);
  res.json(copyStocks);
});

//function to  sorted  based on their Growth.
function growth(stock1, stock2) {
  return stock2.growth - stock1.growth;
}
//Endpoint 2: Get the stocks sorted based on their Growth.
app.get('/stocks/sort/growth', (req, res) => {
  let copyStocks = stocks.slice();
  copyStocks.sort(growth);
  res.json(copyStocks);
});

//function to  filter the stocks based on the 2 Stock Exchange
...
app.get('/stocks/sort/exchange', (req, res) => {
...
app.get('/stocks/sort/industry', (req, res) => {
